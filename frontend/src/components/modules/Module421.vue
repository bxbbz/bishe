<template>
  <div class="module-box">
    <h3>6.2.4 考核评价功能（校内导师端）</h3>
    <el-card style="margin-bottom:20px;">
      <p>本模块支持校内导师对学生进行<strong>多阶段性评价</strong>与<strong>最终综合评价</strong>，评分维度：理论、态度、分析、综合素质。</p>
    </el-card>
      ...
      <el-tab-pane label="阶段性评价" name="stage">
        <el-card style="margin-top:15px;">
          ...
          <el-form :model="stageForm" label-width="120px" style="margin-top:15px;">
            <!-- 校内导师专属评分维度 -->
            <el-form-item label="理论知识" required>
              <el-input v-model.number="stageForm.scores.theory" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="学习态度" required>
              <el-input v-model.number="stageForm.scores.attitude" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="分析能力" required>
              <el-input v-model.number="stageForm.scores.analysis" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="综合素质" required>
              <el-input v-model.number="stageForm.scores.comprehensive" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
      ...
      <el-tab-pane label="最终评价" name="final">
        <el-card style="margin-top:15px;">
          ...
          <el-form :model="finalForm" label-width="120px" style="margin-top:15px;">
            ...
            <!-- 校内导师专属最终评分维度 -->
            <el-form-item label="理论知识" required>
              <el-input v-model.number="finalForm.scores.theory" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="学习态度" required>
              <el-input v-model.number="finalForm.scores.attitude" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="分析能力" required>
              <el-input v-model.number="finalForm.scores.analysis" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
            <el-form-item label="综合素质" required>
              <el-input v-model.number="finalForm.scores.comprehensive" placeholder="0-25分" style="width:200px;"></el-input>
            </el-form-item>
...
const calculateStageScore = () => {
  const total = stageForm.value.scores.theory + stageForm.value.scores.attitude + stageForm.value.scores.analysis + stageForm.value.scores.comprehensive
  if (total > 100) {
    alert('总分不能超过100分！')
...
const calculateFinalScore = () => {
  const total = finalForm.value.scores.theory + finalForm.value.scores.attitude + finalForm.value.scores.analysis + finalForm.value.scores.comprehensive
  if (total > 100) {
    alert('总分不能超过100分！')
